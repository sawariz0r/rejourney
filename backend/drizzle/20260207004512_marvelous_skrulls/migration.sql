...
CREATE TABLE "app_all_time_stats" (
	...
	"total_dead_taps" bigint DEFAULT 0,
...
CREATE TABLE "app_daily_stats" (
	...
	"total_dead_taps" integer DEFAULT 0 NOT NULL,
...
CREATE TABLE "device_usage" (
	...
	CONSTRAINT "device_usage_pkey" PRIMARY KEY("device_id","project_id","period")
);
--> statement-breakpoint
...
CREATE TABLE "projects" (
	...
	"healthy_replays_promoted" double precision DEFAULT 0.05 NOT NULL,
...
CREATE TABLE "session_metrics" (
	...
	"dead_tap_count" integer DEFAULT 0 NOT NULL,
	...
	"screenshot_segment_count" integer DEFAULT 0,
	"screenshot_total_bytes" bigint DEFAULT 0
);
--> statement-breakpoint
CREATE TABLE "sessions" (
	...
	"replay_promotion_score" double precision,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	"segment_count" integer DEFAULT 0,
	"video_storage_bytes" bigint DEFAULT 0,
	"is_sampled_in" boolean DEFAULT true NOT NULL
);
--> statement-breakpoint
...
CREATE INDEX "device_usage_project_idx" ON "device_usage" ("project_id");--> statement-breakpoint
...
ALTER TABLE "device_usage" ADD CONSTRAINT "device_usage_project_id_projects_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE CASCADE;--> statement-breakpoint
