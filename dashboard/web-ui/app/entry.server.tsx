...
const CSP_POLICY = [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://challenges.cloudflare.com https://js.stripe.com https://m.stripe.network https://www.clarity.ms https://scripts.clarity.ms",
    ...
    "connect-src 'self' https://challenges.cloudflare.com https://api.stripe.com https://m.stripe.network https://api.mapbox.com https://events.mapbox.com https://*.tiles.mapbox.com https://www.clarity.ms https://*.clarity.ms https://c.bing.com",
