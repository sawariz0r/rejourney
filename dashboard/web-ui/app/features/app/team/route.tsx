...
export const TeamSettings: React.FC = () => {
  ...
  if (!currentTeam) {
    return (
      <SettingsLayout className="firebase-settings-page firebase-team-settings-page" title="Team" description="Select a team to manage" icon={<Users className="w-6 h-6" />} iconColor="bg-[#f4f4f5]">
  ...
  return (
    <SettingsLayout
      className="firebase-settings-page firebase-team-settings-page"
      title="Team"
