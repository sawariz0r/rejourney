...
const productStories = [
    {
        ...
        icon: Eye,
        accent: 'bg-[#e8f4ff]',
        imageFrameClassName: 'flex h-full items-center justify-center border-2 border-black bg-[#e8f4ff] p-2 sm:p-3',
        imageClassName: 'h-auto max-h-[390px] w-full object-contain object-center',
    },
    {
        copyIndex: 1,
    ...
    },
    {
        ...
        icon: ClipboardList,
        accent: 'bg-[#dbeafe]',
        imageFrameClassName: 'flex h-full items-center justify-center border-2 border-black bg-[#dbeafe] p-2 sm:p-3',
        imageClassName: 'h-auto max-h-[390px] w-full object-contain object-center',
    },
    {
        copyIndex: 4,
