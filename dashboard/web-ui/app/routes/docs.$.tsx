/**
 * Catch-all docs route for markdown-based documentation
  ...
  return (
    <DocsLayout sidebar={<DocsSidebar />}>
      ...
      <header className="mb-12">
        {metadata.category && (
          <p className="text-sm text-gray-500 uppercase tracking-wide mb-2">{metadata.category}</p>
        )}
        <h1 className="text-3xl font-bold text-black mb-3">{metadata.title}</h1>
      </header>
