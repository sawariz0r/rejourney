...
export const mobileSessionReplayCostArticle: Article = {
    ...
    seo: {
        ...
        metaDescription:
            "The engineering decisions behind Rejourney's fixed pricing: 1.25× capture scale, Redis-buffered async ingest, CloudNativePG, and self-hosted k3s on Hetzner.",
        targetKeywords: [
            "session replay pricing",
