...
const englishContentCopy: ContentLocaleCopy = {
  ...
  relatedArticlesHeading: "Related reading",
  relatedArticlesIntro: "Keep going with nearby Rejourney engineering notes.",
  ...
  pricing: {
    ...
    enterpriseHeading: (sessions) => `Need more than ${sessions} monthly session replays?`,
    enterpriseCopy:
    ...
    sessionsPerMonthLabel: "Session replays per month",
    monthlySessionsAriaLabel: "Monthly session replays",
