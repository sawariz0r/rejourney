...
@objc(RJNativeRejourneyURLProtocol)
class RejourneyURLProtocol: URLProtocol {
...
private final class SessionDelegateAdapter: NSObject, URLSessionDataDelegate, URLSessionTaskDelegate, @unchecked Sendable {
