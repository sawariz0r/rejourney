...
=======
    /**
     * Set remote configuration from backend (JS side fetches this from /api/sdk/config)
     * This applies server-side settings before session recording begins
     */
    fun setRemoteConfig(
        ...
        // Store config in ReplayOrchestrator
